...
let Tab1Page = class Tab1Page {
    ...
    open_view() {
        ...
        cordova.plugins.initliseCardPayment('https://fts-uat.cardconnect.com/cardsecure/api/v1/ccn/tokenize', 'mss', 'test').then(result => {
            console.log('test secuccess', result);
        }).catch((err) => {
            console.log('test secucc', err);
            //write your error result here
        });
    }
};
